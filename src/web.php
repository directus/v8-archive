...
$app->add(new \Directus\Application\Http\Middlewares\TableGatewayMiddleware($app->getContainer()))
...
$app->group('/{env}', function () {
    $this->group('/activity', \Directus\Api\Routes\Activity::class)
         ->add(new \Directus\Application\Http\Middlewares\AuthenticationMiddleware($this->getContainer()));
...
$app->group('/interfaces', \Directus\Api\Routes\Interfaces::class)
    ->add(new \Directus\Application\Http\Middlewares\AuthenticationMiddleware($app->getContainer()));
