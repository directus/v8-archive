...
# Database: directus
# Generation Time: 2018-10-22 20:22:28 +0000
# ************************************************************
...
VALUES
	...
	(117,'directus_users','timezone','string','dropdown','{\"choices\":{\"America\\/Puerto_Rico\":\"Puerto Rico (Atlantic)\",\"America\\/New_York\":\"New York (Eastern)\",\"America\\/Chicago\":\"Chicago (Central)\",\"America\\/Denver\":\"Denver (Mountain)\",\"America\\/Phoenix\":\"Phoenix (MST)\",\"America\\/Los_Angeles\":\"Los Angeles (Pacific)\",\"America\\/Anchorage\":\"Anchorage (Alaska)\",\"Europe\\/Paris\":\"Paris (Europe)\",\"Pacific\\/Honolulu\":\"Honolulu (Hawaii)\"},\"placeholder\":\"Choose a timezone...\"}',1,NULL,0,0,0,0,11,2,NULL,NULL,NULL),
	(118,'directus_users','locale','string','dropdown','{\"choices\":{\"en-US\":\"English (US)\",\"fr-FR\":\"Français (France)\",\"nl-NL\":\"Dutch (Nederlands)\",\"de-DE\":\"German (Deutsche)\"},\"placeholder\":\"Choose a language...\"}',1,NULL,0,0,0,0,12,2,NULL,NULL,NULL),
...
VALUES
	(20180220023138,'CreateActivityTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023144,'CreateActivitySeenTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023152,'CreateCollectionsPresetsTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023157,'CreateCollectionsTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023202,'CreateFieldsTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023208,'CreateFilesTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023213,'CreateFoldersTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023217,'CreateRolesTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023226,'CreatePermissionsTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023232,'CreateRelationsTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023238,'CreateRevisionsTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023243,'CreateSettingsTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180220023248,'CreateUsersTable','2018-10-22 20:22:15','2018-10-22 20:22:15',0),
	(20180426173310,'CreateUserRoles','2018-10-22 20:22:15','2018-10-22 20:22:15',0);
...
VALUES
	(1,'active','Admin','User','admin@example.com','$2y$10$pMNlN2d8Y3JnINCilizxh.bFk404EXQY245kJ30r4s7bfqBHwIfhu',NULL,'America/New_York','en-US',NULL,NULL,NULL,NULL,1,NULL,NULL,NULL);
