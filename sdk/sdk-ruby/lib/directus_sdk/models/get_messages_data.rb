...
module DirectusSDK
  ...
  class GetMessagesData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'response_to')
        self.response_to = attributes[:'response_to']
      end
    ...
    def hash
      [id, from, subject, message, attachment, datetime, response_to, read, responses, recipients, date_updated].hash
    end
