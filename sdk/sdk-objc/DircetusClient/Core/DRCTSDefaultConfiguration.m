...
#import "DRCTSBasicAuthTokenProvider.h"
#import "DRCTSLogger.h"

@interface DRCTSDefaultConfiguration ()
...
@implementation DRCTSDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static DRCTSDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"https://myinstance.directus.io/api/1.1";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
        ...
        _logger = [DRCTSLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [DRCTSBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
