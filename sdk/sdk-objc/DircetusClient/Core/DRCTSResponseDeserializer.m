...
NSString *const DRCTSDeserializationErrorDomainKey = @"DRCTSDeserializationErrorDomainKey";

NSInteger const DRCTSTypeMismatchErrorCode = 143553;

NSInteger const DRCTSEmptyValueOccurredErrorCode = 143509;

NSInteger const DRCTSUnknownResponseObjectErrorCode = 143528;


@interface DRCTSResponseDeserializer ()
...
@implementation DRCTSResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:DRCTSDeserializationErrorDomainKey code:DRCTSTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DRCTSDeserializationErrorDomainKey code:DRCTSEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DRCTSDeserializationErrorDomainKey code:DRCTSUnknownResponseObjectErrorCode userInfo:userInfo];
}
