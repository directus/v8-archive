...
VALUES
	...
	(133, 'products', 'status', 'status', 'status', '{\"status_mapping\":{\"1\":{\"name\":\"Published\"},\"2\":{\"name\":\"Draft\",\"published\":\"0\"}}}', 0, NULL, 0, 0, 0, 0, 0, 4, NULL, '0', NULL),
	(134, 'products', 'category_id', 'number', 'many_to_one', NULL, 0, NULL, 0, 0, 0, 0, NULL, 4, NULL, NULL, NULL),
	(135, 'products', 'images', 'o2m', 'one-to-many', NULL, 0, NULL, 0, 0, 0, 0, NULL, 4, NULL, NULL, NULL),
	(136, 'categories', 'id', 'number', 'primary_key', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(137, 'categories', 'products', 'O2M', 'one-to-many', '{\"status_mapping\":{\"1\":{\"name\":\"Published\"},\"2\":{\"name\":\"Draft\",\"published\":\"0\"}}}', 0, NULL, 0, 0, 0, 0, NULL, 4, NULL, NULL, NULL),
	(138, 'categories', 'name', 'string', 'text_input', NULL, 0, NULL, 0, 0, 0, 0, NULL, 4, NULL, NULL, NULL),
	(139, 'languages', 'code', 'string', 'text-input', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(140, 'languages', 'name', 'string', 'text-input', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(141, 'news', 'id', 'integer', 'text-input', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(142, 'news_translations', 'id', 'integer', 'text-input', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(143, 'news_translations', 'title', 'varchar', 'text-input', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(144, 'news_translations', 'content', 'text', 'textarea', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(145, 'news_translations', 'news', 'integer', 'numeric', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(146, 'news_translations', 'language', 'lang', 'lang', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(147, 'news', 'translations', 'translation', 'translation', NULL, 0, NULL, 0, 0, 0, 0, NULL, 4, NULL, NULL, NULL),
	(148, 'home', 'id', 'primary_key', 'numeric', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(149, 'home', 'title', 'varchar', 'text-input', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(150, 'home', 'news', 'o2m', 'one-to-many', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(151, 'home_news', 'id', 'primary_key', 'numeric', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(152, 'home_news', 'home_id', 'integer', 'numeric', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL),
	(153, 'home_news', 'news_id', 'integer', 'numeric', NULL, 0, NULL, 0, 0, 0, 0, 0, 4, NULL, NULL, NULL);
