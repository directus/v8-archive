...
# Generation Time: 2018-01-17 05:26:38 +0000
# ************************************************************
...
VALUES
	(1,1,'00000000001.jpg','Mountain Range','Earth','A gorgeous view of this wooded mountain range','image/jpeg','binary','trees,rocks,nature,mountains,forest',1800,1200,602058,NULL,1,'2017-12-24 04:50:55','local');
...
INSERT INTO `directus_groups` (`id`, `name`, `description`, `restrict_to_ip_whitelist`, `nav_override`, `nav_blacklist`)
VALUES
...
VALUES
	...
	(13,'directus_bookmarks',1,1,1,1,0,3,NULL,NULL,1,NULL);
...
VALUES
	...
	(3,'global','project_url','http://localhost/'),
...
VALUES
	...
	('orders','','',0,0,1,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
VALUES
	(1,1,'Admin','User','admin@getdirectus.com','$2y$12$33aE2lwFwor3frWJfbLZ7uJGMRebdUAGJKm1a0/l6rDYnzTmvHpMW','P3icIXmmlo0wTayT','token','','',NULL,'',1,NULL,NULL,'','',1,'//www.gravatar.com/avatar/64e1b8d34f425d19e1ee2ea7236d3028?s=200&d=identicon&r=g',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'en','America/New_York',NULL,NULL,NULL,NULL),
	(2,1,'Intern','User','intern@getdirectus.com','$2y$12$33aE2lwFwor3frWJfbLZ7uJGMRebdUAGJKm1a0/l6rDYnzTmvHpMW','pv6weFhR4Rgxcxuc','intern_token','','',NULL,'',1,NULL,NULL,'','',3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'en','America/New_York',NULL,NULL,NULL,NULL);
